...
public class AssetsJarFileResolverTest {
   ...
   @Test
    public void testJarAssetManager() throws MalformedURLException {
        ...
        String jarUrl = new File("").getAbsolutePath() + "/../Obstacle/target/Obstacle-1.0-SNAPSHOT.jar!/assets/CRATE.png";
        ...
        am.getAll(Texture.class, out);
        //Texture result = am.get(jarUrl, Texture.class); // jarUrl virker ikke som id
